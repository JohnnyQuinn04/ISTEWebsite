...
<main>
    ...
    <h1>Examples of Contrast</h1>

    <h2>Example 1: Color</h2>
    ...
    <h2>Example 3: Text and Images</h2>
    ...
    <img src="assets/images/contrast-example2.png" alt="Contrast example: text over dark blurred image">
