...
<main>
    ...
    <ul>
        <li>Establishes a visual hierarchy, emphasizing the importance of some elements over others.</li>
        <li>Ensures elements pop out from the background and are highlighted for the user.</li>
        <li>Improves user experience by allowing users to immediately know how to navigate a site.</li>
        <li>Provides accessibility for users with visual impairments.</li>
        <li>Enhances legibility by establishing font sizes and colors.</li>
    </ul>
