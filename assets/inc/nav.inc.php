...
<nav>
    ...
    <ul class="navbar">
        <!-- Contrast Dropdown -->
        <li class="dropdown">
            <p <?php if($heading=="Contrast") echo 'id="currentDir"';?> style="text-decoration-color: <?php echo $color ?>">Contrast</p>
        ...
        <!-- Repetition Dropdown -->
        <li class="dropdown">
            <p <?php if($heading=="Repetition") echo 'id="currentDir"';?> style="text-decoration-color: <?php echo $color ?>">Repetition</p>
            <ul class="dropdown-menu">
        ...
        <!-- Alignment Dropdown -->
        <li class="dropdown">
            <p <?php if($heading=="Alignment") echo 'id="currentDir"';?> style="text-decoration-color: <?php echo $color ?>">Alignment</p>
            <ul class="dropdown-menu">
        ...
        <!-- Proximity Dropdown -->
        <li class="dropdown">
            <p <?php if($heading=="Proximity") echo 'id="currentDir"';?> style="text-decoration-color: <?php echo $color ?>">Proximity</p>
            <ul class="dropdown-menu">
